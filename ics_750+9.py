...
raw_file = 'data_750+9/750+9_frequency.mat'
SMILES_file = 'data_750+9/drug_SMILES_759.csv'
blind_mask_mat_file = './data_750+9/blind_mask_mat.mat'
side_effect_label = "data_750+9/side_effect_label_750.mat"
...
def generateMat():
    """
    将矩阵按比例mask, 将被mask的部分分为10份，生成10份mask位置矩阵，保存在./data_750+9/processed/blind_mask_mat.mat
    :return:
    """
    # 每次加载都把之前的数据删除
...
def split_data(tenfold=False):
    """
    读取./data_750+9/processed/blind_mask_mat.mat，根据原始频率矩阵生成10份被mask的频率矩阵并yield
    :return:
    """
    raw_frequency = scipy.io.loadmat(raw_file)
    print('******************')
...
def evaluate(model, device, loader, sideEffectsGraph, DF, not_FC, result_folder, id):
    ...
    raw_result = pd.DataFrame(total_label.numpy())
...
if __name__ == '__main__':
    ...
    #     print('Missing data_WS files, exit')
    #     # generateMat()
    #     exit(1)
